...
#pragma warning restore 0109
		...
		///</summary>
		[ImplementPropertyType("documentFile")]
		public IEnumerable<IPublishedContent> DocumentFile
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("documentFile"); }
		}
	}
}
